...
const (
		...
		defaultConfigFilename = "xnetworks-controld"

		// The environment variable prefix of all environment variables bound to our command line flags.
		// For example, --number is bound to STING_NUMBER.
		envPrefix = "XNETWORKS_CONTROLD"
)
...
func NewRootCommand() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "xnetworks-controld",
		Short: "eXtropic Networks Cloud Control Daemon",
		Long:  `eXtropic Networks Service for the Management of Heterogeneous Cloud Resources`,
